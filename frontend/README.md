...
$ docker push cr.yandex/${CR_REGISTRY}/iot:latest

$ docker pull cr.yandex/${CR_REGISTRY}/iot:latest

$ docker run cr.yandex/${CR_REGISTRY}/iot:latest

$ docker run -d -p 80:3000 cr.yandex/${CR_REGISTRY}/iot:latest
